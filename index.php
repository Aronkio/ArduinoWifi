<?php   
    ...
    if (isset($_GET['Temp']) && isset($_GET['Hum']) && isset($_GET['Lluv'])){
        $var3 = $_GET['Temp'];
        $var4 = $_GET['Hum'];
        $var5 = $_GET['Lluv'];
        $fileContent = $var3 . "\r\n" . $var4 ."\r\n" . $var5;
...
<body class="container-fluid">
    <div class="row">
        <h1 class="text-center">Cultivo de Tomate</h1>
        <div class="frame">
            <!-- Display Temperatura -->
            <div class="col-sm-6">
                <h2 class="text-center">Saturacion en Cm3</h2>
    ...
    <script>
        ...
        $("#displayTemperatura").sevenSeg({ digits: 5, value: 1023-tempVal });
